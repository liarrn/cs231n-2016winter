...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    ############################################################################
    # conv_dim = (num_filters, input_dim[1]-filter_size+1, input_dim[2]-filter_size+1)
    max_pool_dim = (num_filters, (input_dim[1]-2)/2+1, (input_dim[2]-2)/2+1)
    self.params = {}
    self.params['W1'] = weight_scale * np.random.randn(num_filters, input_dim[0], filter_size, filter_size)
    self.params['b1'] = np.zeros(num_filters)
    self.params['W2'] = weight_scale * np.random.randn(max_pool_dim[0]*max_pool_dim[1]*max_pool_dim[2], hidden_dim)
